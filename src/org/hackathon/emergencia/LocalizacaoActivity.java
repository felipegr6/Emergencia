package org.hackathon.emergencia;
...
import org.hackathon.emergencia.modelos.Coordenada;
import org.hackathon.emergencia.modelos.Elemento;
import org.hackathon.emergencia.modelos.Hospital;
import org.hackathon.emergencia.modelos.Valor;
    ...
    private class DownloadJson extends AsyncTask<Void, Void, Void> {
        ...
        private void converterJson(String jsonConteudo) {
            ...
            try {
                ...
                String status = conteudo.getString("status");
                // JSONArray jsonDestinos = conteudo
                // .getJSONArray("destination_addresses");
                // JSONArray jsonOrigens = conteudo
                // .getJSONArray("origin_addresses");
                ...
                if (status.equals("OK")) {
                    ...
                    for (int i = 0; i < jsonLinhas.length(); i++) {
                        ...
                        for (int j = 0; j < jsonElementos.length(); j++) {
                            ...
                            Valor distancia = new Valor();
                            Valor duracao = new Valor();
                            String statusElemento = "";
            ...
            if (elementos.size() != 0
                    && elementos.get(0).getStatus().equals("OK")) {
